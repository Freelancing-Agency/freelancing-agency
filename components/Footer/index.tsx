          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                ...
                <li>
                  <a href="https://www.instagram.com/opemic_inc/" aria-label="social icon" target="_blank">
                    {/* fdsf */}

                    <svg xmlns="http://www.w3.org/2000/svg"  width="25" height="25" viewBox="0 0 50 40" className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary">
