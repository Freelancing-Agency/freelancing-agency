...
const onSubmit = async (data: FormValues) => {
  ...
  return (
    <>
      {/* <!-- ===== Contact Start ===== --> */}
      <section id="support" className="px-3 md:px-0 2xl:px-0">
        <div className="relative mx-auto max-w-[1600px] px-7 pt-10 lg:px-15 lg:pt-15 xl:px-5 xl:pt-5 ">
          ...
          <div className="flex justify-center">
            <motion.div
              ...
              viewport={{ once: true }}
              className="animate_top w-full rounded-lg bg-white p-7.5 shadow-solid-8 dark:border dark:border-strokedark dark:bg-black md:w-3/5 lg:w-[85%] xl:p-15"
            >
